 ...
 */
public class Aixppc64Linker implements CLinker {
    ...
    static {
        try {
            ...
            MH_boxVaList = lookup.findStatic(Aixppc64Linker.class, "newVaListOfAddress",
    ...
    public static VaList newVaList(Consumer<VaList.Builder> actions, SharedUtils.Allocator allocator) {
        AixVaList.Builder builder = AixVaList.builder(allocator);
    ...
    public MethodHandle downcallHandle(Addressable symbol, MethodType type, FunctionDescriptor function) {
        ...
        MethodType llMt = SharedUtils.convertVaListCarriers(type, AixVaList.CARRIER);
