 ...
 */
public class AixVaList implements VaList {
    ...
    private AixVaList(MemorySegment segment, MemorySegment regSaveArea, List<MemorySegment> attachedSegments) {
    ...
    private static AixVaList readFromSegment(MemorySegment segment) {
        ...
        return new AixVaList(segment, regSaveArea, List.of(regSaveArea));
    }
    ...
    private static MemoryAddress emptyListAddress() {
        ...
        MemorySegment base = MemoryAddress.ofLong(ptr)
                ...
                .share();
        cleaner.register(AixVaList.class, base::close);
    ...
    static AixVaList.Builder builder(SharedUtils.Allocator allocator) {
        return new AixVaList.Builder(allocator);
    }
    ...
    private VaList copy(SharedUtils.Allocator allocator) {
        ...
        return new AixVaList(copy, regSaveArea, List.of());
    }
    ...
    static class Builder implements VaList.Builder {
        ...
        public VaList build() {
            ...
            return new AixVaList(vaListSegment, reg_save_area, attachedSegments);
        }
    }
